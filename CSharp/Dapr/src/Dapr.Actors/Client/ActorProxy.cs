...
namespace Dapr.Actors.Client
{
    ...
    {
        internal static readonly ActorProxyFactory ActorProxyFactory = new ActorProxyFactory();
        ...
        /// <summary>
        /// The <see cref="IActorProxyFactory"/> to use when creating new <see cref="ActorProxy"/> instances
        /// </summary>
        public static void ConfigureDefaultFactory(Action<ActorProxyFactory> configureDelegate)
        {
            configureDelegate.Invoke(ActorProxyFactory);
        }
        ...
        {
            return ActorProxyFactory.CreateActorProxy<TActorInterface>(actorId, actorType);
        }
        ...
        public static object Create(ActorId actorId, Type actorInterfaceType, string actorType)
        {
            ...
            return ActorProxyFactory.CreateActorProxy(actorId, actorInterfaceType, actorType);
        }
        ...
        {
            return ActorProxyFactory.Create(actorId, actorType);
        }
          ...
          JsonSerializerOptions jsonSerializerOptions = null)
        {
            ...
            this.jsonSerializerOptions = jsonSerializerOptions ?? this.jsonSerializerOptions;
        }
