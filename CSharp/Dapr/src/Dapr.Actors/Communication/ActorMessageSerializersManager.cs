...
namespace Dapr.Actors.Communication
{
    ...
    internal class ActorMessageSerializersManager
    {
        ...
        {
            this.serializationProvider = serializationProvider ?? new ActorMessageBodyDataContractSerializationProvider(); // new ActorMessageBodyJsonSerializationProvider();
            this.cachedBodySerializers = new ConcurrentDictionary<int, CacheEntry>();
            this.headerSerializer = headerSerializer ?? new ActorMessageHeaderSerializer();;
        }
